...
<a href="cuentas" class="collection-item white-text cyan darken-1">Cuentas</a>
...
@section('btn-area')
    <a class="waves-effect waves-cyan btn"><i class="mdi-content-add left"></i>Nueva Cuenta</a>
@stop